...
class Plugin
{
    public static function load(EventEmitterInterface $eventEmitter)
    {
        $eventEmitter->on('peridot.reporters', function(InputInterface $input, ReporterFactory $reporterFactory) {
